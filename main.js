...
function showPaymentInfo() {
  ...
  paymentInfoList[0].innerHTML = `
  ${loanAmount.value.toLocaleString()} FCFA`;
  paymentInfoList[1].innerHTML = `
  ${interestRate.value}%`;
  paymentInfoList[2].innerHTML = noOfMonth.value;
  paymentInfoList[3].innerHTML = `
  ${parseFloat(monthlyPayment).toLocaleString()} FCFA`;
}
